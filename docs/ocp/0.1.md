...
**User install:** [`../../INSTALL.md`](../../INSTALL.md)
...
**Operator recipe (MiMo):** concrete `register` → `resolveProvider` sidecar, success criteria, and “does not feed `mimo models`” boundary — [`docs/hosts/mimo.md`](../hosts/mimo.md) §3.
...
| 2026-07-20 | Documented Option B provider LanguageModel adoption (`streamToolCallEnsure` / `bashDescriptionRequired`); linked [`INSTALL.md`](../../INSTALL.md); framed train as `0.1.x` |

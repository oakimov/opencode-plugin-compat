...
Also owns **Option B** LanguageModel adoption helpers used by `ocp setup` provider entry shims (`streamToolCallEnsure`, `bashDescriptionRequired` — see [OCP 0.1 §6.5](../../docs/ocp/0.1.md)).

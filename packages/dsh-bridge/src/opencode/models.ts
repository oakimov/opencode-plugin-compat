...
import { expandModelVariants, thinkingConfigFor, type ExpandedVariantModel, type ExpandOptions, type HostProfileForVariants } from "./variants.js"
...
export function expandEntry(
  ...
  profile: HostProfileForVariants,

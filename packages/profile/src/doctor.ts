...
export function zcodeDoctorMessage(): string {
  return [
    ...
    "Companion (not OCP): pack plugin-package skills/commands/manifests with `compat migrate-zcode` (does not migrate host MCP; see docs/guides/zcode-import-and-migrate.md).",
  ].join(" ")
}
